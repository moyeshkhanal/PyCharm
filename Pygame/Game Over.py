...
while not done:
    ...
    for event in pygame.event.get():
        ...
        # own game when you know the game is over. (Like lives==0)
            ...
            game_over = True
            if Mouse_x > 10 and Mouse_x < 40:
                if Mouse_y > 10 and Mouse_y < 20:
                    print("Hello There")
    ...
    pygame.draw.rect(screen, (255, 0, 0), [10, 20, 40, 20])
    ...
    if game_over:
        ...
        text_x = int(screen.get_width() / 2 - text_rect.width / 2)
        text_y = int(screen.get_height() / 2 - text_rect.height / 2)
